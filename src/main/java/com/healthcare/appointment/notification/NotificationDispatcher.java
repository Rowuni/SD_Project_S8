...
/**
 * Observer that reacts to appointment lifecycle events and routes
 * notifications.
 *
 * DESIGN PATTERN - Observer (ConcreteObserver)
 * SOLID - SRP: Only responsible for receiving events and dispatching
 * notifications.
 * SOLID - DIP: Depends on NotificationChannel abstraction and
 * NotificationFactory.
 * GRASP - Pure Fabrication: Not a domain concept; created for routing
 * notification logic.
 * GRASP - Indirection: Mediates between Appointment (event source) and concrete
 * channels.
 */
